                ...
                <ul class="navbar-nav navbar-nav-right">
                    <li class="nav-item nav-profile dropdown">
                        ...
                        <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
                            <a class="dropdown-item" href="?c=administrador&a=editarPerfilUsuario&idUsuario=<?php echo $idUsuario; ?>">
                                <i class="mdi mdi-account mr-2 text-primary"></i> Editar perfil </a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="?c=administrador&a=backup">
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="?c=negocios&a=negocios">Negocios Registrados</a></li>
                                <li class="nav-item"> <a class="nav-link" href="?c=peticionNegocio&a=petiNegocios">Peticiones de Negocios</a></li>
                                <li class="nav-item"> <a class="nav-link" href="?c=tipoNegocio&a=tipoNegocios">Tipo de Negocio</a></li>
                            </ul>                        
                            
                        </div>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="?c=administrador&a=modificionusuarios">
                            <span class="menu-title">Usuarios</span>
                            <i class="mdi mdi-contacts menu-icon"></i>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="?c=documento&a=documento">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="?c=pago&a=pago">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="?c=administrador&a=chat">
