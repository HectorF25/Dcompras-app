    ...
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">
                ...
                </span> Modificación de Tipos de pago
            </h3>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="?c=pago&a=Guardar" target="" method="POST" value="<?php echo $tipoPago->idTipoPago; ?>" class="form-sample" id="formulario">
                        <input type="hidden" id="idTipoPago" name="idTipoPago" value="<?php echo $tipoPago->idTipoPago; ?>" />
                        <div class="row">
                            <div class="col-md-6 formulario__grupo" id="grupo__nombreNegocio">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9 formulario__grupo-input ">
                                        <input type="text" class="form-control formulario__input" name="nombreTipoPago" id="nombreTipoPago" value="<?php echo $tipoPago->nombreTipoPago; ?>" />
