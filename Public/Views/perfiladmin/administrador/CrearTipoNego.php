    ...
    <div class="content-wrapper">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="?c=tipoNegocio&a=Guardar" target="" method="POST" value="<?php echo $negocios->getIdTipoNegocio(); ?>" class="form-sample" id="formulario">
                        <input type="hidden" id="idTipoNegocio" name="idTipoNegocio" value="<?php echo $negocios->getIdTipoNegocio(); ?>" />
                            ...
                            <div class="col-md-6 formulario__grupo" id="grupo__nombreNegocio">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9 formulario__grupo-input ">
                                        <input type="text" class="form-control formulario__input" name="nombreTipoNegocio" id="nombreNegocio" value="<?php echo $negocios->getNombreTipoNegocio(); ?>" />
