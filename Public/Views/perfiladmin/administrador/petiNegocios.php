                        ...
                        <li class="list-group-item p-3">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <a class="btn btn-gradient-primary mr-2 float-left" href="?c=negocios1&a=crudNegocio"><i class="mdi mdi-store menu-icon"> Nueva Petición de Negocio</i></a>
                                            ...
                                            <tbody>
                                                <?php foreach ($this->model->ListarNegocio() as $c) : ?>
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td>
                                                            <a id="btn-abrir-popup" href="?c=negocios1&a=crudNegocio&idPeticionNegocio=<?php echo $c->idPeticionNegocio; ?>"  class="btn-abrir-popup">Modificar</a>
                                                        </td>
                                                        <td>
                                                            <a id="btn-abrir-popup" href="?c=negocios1&a=Eliminar&idPeticionNegocio=<?php echo $c->idPeticionNegocio; ?>" class="btn-abrir-popup">Eliminar</a>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                                            </tbody>
