    ...
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">
                ...
                </span> Peticiones de negocios
            </h3>
            <nav aria-label="breadcrumb">
                <ul class="breadcrumb">
                    <li class="breadcrumb-item active" aria-current="page">
                        <span></span>Informacion de Peticiones de negocios<i class="mdi mdi-alert-circle-outline icon-sm text-primary align-middle"></i>
                    </li>
                </ul>
            </nav>
        </div>
        <div class="row">
            <div class="col-md-4 stretch-card grid-margin" style="height: 150px;">
                <div class="card bg-gradient-danger card-img-holder text-white">
                    <div class="card-body">
                        ...
                        <h4 class="font-weight-normal mb-3" style="color: white;">Peticiones registradas <i class="mdi mdi-chart-line mdi-24px float-right"></i>
                        </h4>
            ...
            <div class="col-md-4 stretch-card grid-margin" style="height: 150px;">
                <div class="card bg-gradient-info card-img-holder text-white">
                    <div class="card-body">
                        <img src="../assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                        <h4 class="font-weight-normal mb-3" style="color: white;">Peticiones aceptadas <i class="mdi mdi-bookmark-outline mdi-24px float-right"></i>
                        </h4>
                        <h2 class="mb-5">3</h2>
                    </div>
                </div>
            ...
            <div class="col-md-4 stretch-card grid-margin" style="height: 150px;">
                <div class="card bg-gradient-success card-img-holder text-white">
                    <div class="card-body">
                        <img src="../assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                        <h4 class="font-weight-normal mb-3" style="color: white;">Peticiones rechazadas <i class="mdi mdi-diamond mdi-24px float-right"></i>
                        </h4>
                        <h2 class="mb-5">0</h2>
                    </div>
                </div>
                        ...
                        <li class="list-group-item p-3">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <a class="btn btn-gradient-primary mr-2 float-left" href="?c=peticionNegocio&a=crudNegocio"><i class="mdi mdi-store menu-icon"> Nueva Petición de Negocio</i></a>
                                        ...
                                        <table id="tablaUsu" class="table table-striped">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="bootstrap-data-table" rowspan="1" colspan="1" aria-label="Rol: activate to sort column ascending" style="width: 140px;">Nombre Propietario</th>
                                                    <th class="sorting" tabindex="0" aria-controls="bootstrap-data-table" rowspan="1" colspan="1" aria-label="Ciudad: activate to sort column ascending" style="width: 80px;">Nit</th>
                                                    <th class="sorting" tabindex="0" aria-controls="bootstrap-data-table" rowspan="1" colspan="1" aria-label="Estado: activate to sort column ascending" style="width: 169.889px;">Razón social</th>
                                                    <th class="sorting" tabindex="0" aria-controls="bootstrap-data-table" rowspan="1" colspan="1" aria-label="Estado: activate to sort column ascending" style="width: 80px;">Telefono</th>
                                                    <th class="sorting" tabindex="0" aria-controls="bootstrap-data-table" rowspan="1" colspan="1" aria-label="Estado: activate to sort column ascending" style="width: 80px;">Fecha fundación</th>
                                            ...
                                            <tbody>
                                                <?php foreach ($this->model->ListarNegocio() as $c) : ?>
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td><?php echo $c->nombrePropietario; ?></td>
                                                        <td><?php echo $c->nitNegocio; ?></td>
                                                        <td><?php echo $c->razonsocialNegocio; ?></td>
                                                        <td><?php echo $c->telefonoNegocio; ?></td>
                                                        <td><?php echo $c->fechaFundacion; ?></td>
                                                        <td><?php echo $c->nombreTipoNegocio; ?></td>
                                                        <td>
                                                            <a id="btn-abrir-popup" href="?c=peticionNegocio&a=crudNegocio&idPeticionNegocio=<?php echo $c->idPeticionNegocio; ?>"  class="btn-abrir-popup">Modificar</a>
                                                        </td>
                                                        <td>
                                                            <a id="btn-abrir-popup" href="?c=peticionNegocio&a=Eliminar&idPeticionNegocio=<?php echo $c->idPeticionNegocio; ?>" class="btn-abrir-popup">Eliminar</a>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                                            </tbody>
