                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="table-responsive">
                                        <a class="btn btn-gradient-primary mr-2 float-left" href="?c=categoria&a=crudCategoria"><i class="mdi mdi-store menu-icon"> Nueva categoria</i></a>
                                        ...
                                        <table id="tablaUsu" class="table table-striped">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting_asc" tabindex="0" aria-controls="bootstrap-data-table" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Nombre: activate to sort column descending" style="width: 180.889px;">Nombre Categoría</th>
                                            ...
                                            <tbody>
                                                <?php foreach ($this->model->Listar() as $c) : ?>
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td>
                                                            <a id="btn-abrir-popup" href="?c=categoria&a=crudCategoria&idCategoria=<?php echo $c->idCategoria; ?>" class="btn-abrir-popup">Modificar</a>
                                                        </td>
                                                        <td>
                                                            <a id="btn-abrir-popup" class="btn-abrir-popup" onclick="javascript: deleteCategoria(<?php echo $c->idCategoria; ?>)">Eliminar</a>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                                            </tbody>
