    ...
    <div class="content-wrapper">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="?c=negocios1&a=Guardar" target="" method="POST" value="<?php echo $negocios->getIdPeticionNegocio(); ?>" class="form-sample" id="formulario">
                    <input type="hidden" id="idPeticionNegocio" name="idPeticionNegocio" value="<?php echo $negocios->getIdPeticionNegocio(); ?>" />
                            ...
                            <div class="col-md-6 formulario__grupo" id="grupo__nombreNegocio">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9 formulario__grupo-input">
                                        <input type="text" class="form-control formulario__input" name="nombreNegocio" id="nombreNegocio" value="<?php echo $negocios->getNombreNegocio() ?>" />
                        ...
                        <div class="col-sm-9  formulario__grupo-input">
                            <input type="text" class="form-control formulario__input" name="nombrePropietario" id="nombreNegocio" value="<?php echo $negocios->getNombrePropietario() ?>">
                            <i class="formulario__validacion-estado fas fa-times-circle"></i>
                        </div>
                        ...
                        <div class="col-md-6 formulario__grupo" id="grupo__nitNegocio">
                            ...
                            <div class="col-md-6 formulario__grupo" id="grupo__nombreNegocio">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9 formulario__grupo-input">
                                        <input type="text" class="form-control formulario__input" name="nombreTipoNegocio" id="nombreNegocio" placeholder="800.197.268-4" value="<?php echo $negocios->getNombreTipoNegocio() ?>" />
                                        <i class="formulario__validacion-estado fas fa-times-circle"></i>
                                    </div>
                        ...
                        <div class="col-md-6 formulario__grupo" id="grupo__fechaFundacion">
                            ...
                            <div class="col-md-6 formulario__grupo" id="grupo__fechaFundacion">
                                <div class="form-group row">
                                    ...
                                    <input type="textarea" class="form-control formulario__input" name="razonsocialNegocio"
                                             value="<?php echo $negocios->getRazonSocialNegocio() ?>" />
                                        <i class="formulario__validacion-estado fas fa-times-circle"></i>
                                    </div>
                                </div>
                            </div>
                            ...
                            <button type="submit" class="btn btn-gradient-primary crear" style="float: right;">Crear petición</button>
