    ...
    <div class="content-wrapper">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="?c=negocios&a=Guardar" target="" method="POST"
                        value="<?php echo $negocios->getIdNegocio(); ?>" class="form-sample" id="formulario">
                        <input type="hidden" id="idNegocio" name="idNegocio"
                            value="<?php echo $negocios->getIdNegocio(); ?>" />
                            ...
                            <div class="col-md-6 formulario__grupo" id="grupo__nombreNegocio">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9 formulario__grupo-input">
                                        <input type="text" class="form-control formulario__input" name="nombreNegocio"
                                            id="nombreNegocio" placeholder="Supermercado Policarpa"
                                            value="<?php echo $negocios->getNombreNegocio() ?>" />
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9  formulario__grupo-input">
                                        <input type="text" class="form-control formulario__input"
                                            name="direccionNegocio" id="direccionNegocio"
                                            placeholder="Carrea 12 #4-05 sur"
                                            value="<?php echo $negocios->getDireccionNegocio() ?>">
                                        <i class="formulario__validacion-estado fas fa-times-circle"></i>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 formulario__grupo" id="grupo__nitNegocio">
                                <div class="form-group row">
                                    <label for="nitNegocio" class="col-sm-3 col-form-label formulario__label">Nit del
                                        negocio</label>
                                    <div class="col-sm-9 formulario__grupo-input">
                                        <input type="text" class="form-control formulario__input" name="nitNegocio"
                                            id="nitNegocio" placeholder="800.197.268-4"
                                            value="<?php echo $negocios->getNitNegocio() ?>" />
                                        <i class="formulario__validacion-estado fas fa-times-circle"></i>
                                    </div>
                            ...
                            <div class="col-md-6" id="grupo__estadoNegocio">
                                <div class="form-group row">
                                    <label for="estadoNegocio" class="col-sm-3 col-form-label formulario__label"
                                        class="col-sm-3 col-form-label">Estado</label>
                                    <div class="col-sm-9 formulario__grupo-input ">
                                        <select class="formulario__input form-control" name="estadoNegocio"
                                            id="estadoNegocio">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9 formulario__grupo-input">
                                        <input type="date" class="form-control formulario__input" name="fechaFundacion"
                                            id="fechaFundacion" value="<?php echo $negocios->getFechaFundacion() ?>" />
                                        <i class="formulario__validacion-estado fas fa-times-circle"></i>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9 formulario__grupo-input">
                                        <input type="number" class="form-control formulario__input" name="telefonoNegocio"
                                            ...
                                            value="<?php echo $negocios->getTelefonoNegocio() ?>" />
                                        <i class="formulario__validacion-estado fas fa-times-circle"></i>
                                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6" id="grupo__TipoNegocio">
                    <div class="form-group row">
                        <label for="TipoNegocio" class="col-sm-3 col-form-label formulario__label"
                            class="col-sm-3 col-form-label">Tipo de negocio</label>
                        <div class="col-sm-9 formulario__grupo-input ">
                            <select class="formulario__input form-control" id="idTipoNegocio" name="idTipoNegocio"
                                required>
