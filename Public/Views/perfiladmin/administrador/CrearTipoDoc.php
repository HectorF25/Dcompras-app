    ...
    <div class="content-wrapper">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="?c=documento&a=Guardar" target="" method="POST" value="<?php echo $documento->getIdTipoDoc(); ?>" class="form-sample" id="formulario">
                        <input type="hidden" id="idTipoDoc" name="idTipoDoc" value="<?php echo $documento->getIdTipoDoc(); ?>" />
                            ...
                            <div class="col-md-6 formulario__grupo" id="grupo__nombreNegocio">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9 formulario__grupo-input ">
                                        <input type="text" class="form-control formulario__input" name="nombreTipoDoc" id="nombreTipoDoc" value="<?php echo $documento->getNombreTipoDoc(); ?>" />
                        ...
                        <div class="row">
                            ...
                            <button type="submit" class="btn btn-gradient-primary crear" style="float: right;">Guardar registro</button>
