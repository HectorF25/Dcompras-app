...
<main>
    <form action="?c=negocios&a=Guardar" target="" method="POST" value="<?php echo $negocios->idNegocio; ?>" class="formulario" id="formulario">
    <h2>Modificar Negocio</h2><br />
     ...
     <!-- Grupo: Usuario -->
        <div class="formulario__grupo" id="grupo__nombreNegocio">
            ...
            <div class="formulario__grupo-input">
                <input type="text" class="formulario__input" name="nombreNegocio" id="nombreNegocio" value="<?php echo $negocios->nombreNegocio ?>">
        ...
        <div class="formulario__grupo" id="grupo__direccionNegocio">
            ...
            <div class="formulario__grupo-input">
                <input type="text" class="formulario__input" name="direccionNegocio" id="direccionNegocio" value="<?php echo $negocios->direccionNegocio ?>">
                <i class="formulario__validacion-estado fas fa-times-circle"></i>
            </div>
        ...
        <div class="formulario__grupo-input">
                    ...
                    <option value="<?php echo $negocios->estadoNegocio; ?>"><?php if($negocios->estadoNegocio==TRUE){echo "ACTIVO";}else{echo "INACTIVO";} ?></option>                         <option value="TRUE">ACTIVO</option>
        ...
        <div class="formulario__grupo" id="grupo__idUsuario">
            ...
            <div class="formulario__grupo-input">
                <input type="text" class="formulario__input" name="idUsuario" id="idUsuario" placeholder="1" value="<?php echo $negocios->idUsuario ?>">
                <i class="formulario__validacion-estado fas fa-times-circle"></i>
            </div>
        ...
        <div class="formulario__grupo" id="grupo__idPeticionNegocio">
            ...
            <div class="formulario__grupo-input">
                <input type="text" class="formulario__input" name="idPeticionNegocio" id="idPeticionNegocio" placeholder="1" value="<?php echo $negocios->idPeticionNegocio ?>">
                <i class="formulario__validacion-estado fas fa-times-circle"></i>
            </div>
