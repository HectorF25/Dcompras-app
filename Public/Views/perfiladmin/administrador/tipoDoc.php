                        ...
                        <li class="list-group-item p-3">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <a class="btn btn-gradient-primary mr-2 float-left" href="?c=documento&a=crudNegocio"><i class="mdi mdi-store menu-icon"> Nuevo tipo de doc.</i></a>
                                            ...
                                            <tbody>
                                                <?php foreach ($this->model->ListarNegocio() as $c) : ?>
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td>
                                                            <a id="btn-abrir-popup" href="?c=documento&a=crudNegocio&idTipoNegocio=<?php echo $c->idTipoDoc; ?>"  class="btn-abrir-popup">Modificar</a>
                                                        </td>
                                                        <td>
                                                            <a id="btn-abrir-popup" href="?c=documento&a=Eliminar&idTipoNegocio=<?php echo $c->idTipoDoc; ?>" class="btn-abrir-popup">Eliminar</a>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                                            </tbody>
