...
require_once './modules/functionVendedor.php';

error_reporting(0);
$idUsuario = $_SESSION["idUsuario"];
$correoUsuario = $_SESSION['correo'];
$idPerfilUsuario = $_SESSION["idPerfilUsuario"];
if (!isset($correoUsuario) || $idPerfilUsuario != 3) {
...
?>
    ...
    <head>
        ...
        <title>Dcompras | Vendedor de administrador</title>
        <!-- plugins:css -->
                    ...
                    <ul class="navbar-nav navbar-nav-right">
                        <li class="nav-item nav-profile dropdown">
                            ...
                            <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
                                <a class="dropdown-item" href="./vendedor/?c=vendedor&a=editarPerfilUsuario&idUsuario=<?php echo $idUsuario; ?>">
            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <nav class="sidebar sidebar-offcanvas" id="sidebar">
                    <ul class="nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="PerfilVendedor">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="ui-basic">
                                <ul class="nav flex-column sub-menu">
                                    <li class="nav-item"> <a class="nav-link" href="./vendedor/?c=crearProductos&a=catalogoVendedor">Catalogo</a></li>
                                    <li class="nav-item"> <a class="nav-link" href="./vendedor/?c=crearProductos&a=mostrarProductos">Productos</a></li>
                                    <li class="nav-item"> <a class="nav-link" href="./vendedor/?c=crearProductos&a=tipoNegocios">Datos negocio</a></li>

                                </ul>
                            </div>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="./administrador/?c=categoria&a=categoria">
                                <span class="menu-title">Domicilios</span>
