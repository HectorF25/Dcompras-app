                                        ...
                                        <table id="tablaUsu" class="table table-striped">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="bootstrap-data-table" rowspan="1" colspan="1" aria-label="Estado: activate to sort column ascending" style="width: 100px;">Modificar</th>
                                                    <th class="sorting" tabindex="0" aria-controls="bootstrap-data-table" rowspan="1" colspan="1" aria-label="Estado: activate to sort column ascending" style="width: 100px;">Inactivar</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php foreach ($this->model->ListarProducto() as $c) : ?>
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td>
                                                            <a onclick="javascript:return confirm('¿Seguro de inactivar este registro?');" href="?c=crearProductos&a=inactivar&idProductoNegocio=<?php echo $c->idProductoNegocio; ?>">Inactivar</a>
                                                        </td>
