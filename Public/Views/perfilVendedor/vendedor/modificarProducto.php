...
<main>
    <form action="?c=crearProductos&a=Guardar" method="POST" value="<?php echo $crearP->idProductoNegocio; ?>" class="formulario" id="formulario">
    ...
    <!-- Grupo: Usuario -->
        <div class="formulario__grupo" id="grupo__idProducto">
            ...
            <div class="formulario__grupo-input">
                <input type="text" class="formulario__input" name="idProducto" id="idProducto" value="<?php echo $crearP->idProducto; ?>">
        ...
        <div class="formulario__grupo" id="grupo__idNegocio">
            ...
            <div class="formulario__grupo-input">
                <input type="text" class="formulario__input" name="idNegocio" id="idNegocio" value="<?php echo $crearP->idNegocio; ?>">
                <i class="formulario__validacion-estado fas fa-times-circle"></i>
            </div>
        ...
        <div class="formulario__grupo" id="grupo__cantidadProducto">
            ...
            <div class="formulario__grupo-input">
                <input type="text" class="formulario__input" name="cantidadProducto" id="cantidadProducto" value="<?php echo $crearP->cantidadProducto; ?>">
                <i class="formulario__validacion-estado fas fa-times-circle"></i>
            </div>
