                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Ventas Registradas</strong>
                        </div>
                        <div class="card-body">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="table-responsive">
                                            <div class="well well-sm text-right">
                                                <a class="btn btn-primary" href="?c=negocios&a=crudNegocio">Nuevo Pedido</a>
                                            </div>
                                                ...
                                                <tbody>
                                                    <?php foreach ($this->model->ListarNegocio() as $c) : ?>
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td>
                                                                <a id="btn-abrir-popup" href="?c=clientes&a=crudCliente&idCliente=<?php echo $c->idNegocio; ?>" class="btn-abrir-popup">Modificar</a>
                                                            </td>
                                                            <td>
