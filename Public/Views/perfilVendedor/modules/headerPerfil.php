...
<head>
    ...
    <link rel="stylesheet" id="main-stylesheet" data-version="1.1.0"
        href="../assets/css/shards-dashboards.1.1.0.min.css">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="?c=crearProductos&a=catalogoVendedor">Catalogo</a></li>
                                <li class="nav-item"> <a class="nav-link" href="?c=crearProductos&a=mostrarProductos">Productos</a></li>
                                <li class="nav-item"> <a class="nav-link" href="?c=crearProductos&a=tipoNegocios">Datos negocio</a></li>
