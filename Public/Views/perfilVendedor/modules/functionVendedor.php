...
$consulta3=mysqli_query($conex,"SELECT * FROM negocio INNER JOIN usuario ON negocio.idUsuario = usuario.idUsuario WHERE usuario.idUsuario = $idUsuario");                  
while($filas=mysqli_fetch_array($consulta2)){
     $negocioVendedor=$filas['idNegocio'];                           
}
?>