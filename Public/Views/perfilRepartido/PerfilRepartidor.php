        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="PerfilRepartidor.html"><i class="menu-icon fa fa-laptop"></i>Repartidor</a>
                    </li>
                    <li class="menu-title">Elementos de Consulta</li><!-- /.menu-title -->
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-cogs"></i>Desempeño</a>
                        <ul class="sub-menu children dropdown-menu">   
                        <li><i class="fa fa-file-word-o"></i><a href="Cliengistrados.html">Pedidos Pendientes</a></li>
                        <li><i class="fa fa-id-card-o"></i><a href="NegoRegiss.html">Pedido Encurso</a></li>
                       
                        <li><i class="fa fa-puzzle-piece"></i><a href="Modifacionuarios.html">Cliente</a></li>
                        
                            
                            <li><i class="fa fa-exclamation-triangle"></i><a href="FallasSitema.html">Reportar Fallas</a></li>
                ...
                <div class="orders">
                    <div class="row">
                        <div class="col-xl-8">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="box-title">Mejores Repartidores </h4>
                                </div>
                                <div class="card-body--">
                                        ...
                                        <table class="table ">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td> #0469 </td>
                                                    <td>  <span class="name">Luis Lozano</span> </td>
                                                    <td> <span class="product">iMax</span> </td>
                                                    <td><span class="count">501</span></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <span class="product">D1</span> </td>
                                                    <td><span class="count">480</span></td>
                                                    <td>
                                                        <span class="badge badge-complete">Activo</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td> <span class="product">DOÑA LUZ</span> </td>
                                                    <td><span class="count">475</span></td>
                                                    <td>
                                                        <span class="badge badge-complete">Activo</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td> <span class="product">Tienda PIPE</span> </td>
                                                    <td><span class="count">460</span></td>
                                                    <td>
                                                ...
                                                <tr class=" pb-0">
                                                    ...
                                                    <td> <span class="product">ARA</span> </td>
                                                    <td><span class="count">459</span></td>
                                                    <td>
                                                        <span class="badge badge-complete">Activos</span>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
