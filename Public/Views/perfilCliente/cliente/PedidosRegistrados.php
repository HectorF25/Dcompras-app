                                    ...
                                    <div class="col-sm-12">
                                        <div class="table-responsive">
                                            <div class="well well-sm text-right">
                                                <a class="btn btn-primary" href="?c=pedido&a=crudPedido">Nuevo Pedido</a>
                                            </div>
                                            <table id="tablaPedidos" class="table table-striped table-bordered">
                                                <thead>
                                                    <tr role="row">
                                                        ...
                                                        <th class="sorting" tabindex="0" aria-controls="bootstrap-data-table" rowspan="1" colspan="1" aria-label="Estado: activate to sort column ascending" style="width: 80px;">idDomicilio</th>
                                                ...
                                                <tbody>
                                                    <?php foreach ($this->model->ListarPedido() as $c) : ?>
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td>
                                                                <a id="btn-abrir-popup" href="?c=pedido&a=crudPedido&idPedido=<?php echo $c->idPedido; ?>" class="btn-abrir-popup">Modificar</a>
                                                            </td>
                                                            <td>
