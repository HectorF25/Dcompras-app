            ...
            <div class="container">
                ...
                <div class="page-container row">
                    <div class="sidebar col-lg-4 order-1 order-lg-0 mb-8 mb-lg-0">
                        ...
                        <div class="campaign">
                            <img src="<?= APP_DIR; ?>assets/css/images/other/campaign.jpg" alt="Campaign">
                        </div>
                    </div>
                                    ...
                                    <div class="store card border-0 rounded-0">
                                        <div class="position-relative store-image">
                                            <a href="./detallesProductos">
                                                <img src="<?= APP_DIR; ?>assets/img/productos/<?php echo $producto->imgProducto ?>.jpg" alt="store 1" class="card-img-top rounded-0">
                                            </a>
                                            <div class="image-content position-absolute d-flex align-items-center">
                                                <div class="content-right ml-auto d-flex">
                                                    <a href="<?= APP_DIR; ?>assets/css/images/shop/full-popular-place-2.jpg" class="item viewing" data-toggle="tooltip" data-placement="top" title="Quick view" data-gtf-mfp="true">
