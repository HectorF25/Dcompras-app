...
CREATE TABLE Usuario (
    ...
    apellidoUsuario varchar(10),
    contraseñaUsuario varchar(15),
    correoUsuario varchar(56),
...
CREATE TABLE PeticionNegocio (
    ...
    nombreNegocio varchar(20),
    nombrePropietario varchar(10),
    nitNegocio int,
    razonsocialNegocio varchar(15),
    telefonoNegocio int,
    fechaFundacion date,
    nombreTipoNegocio varchar(15)
);
...
CREATE TABLE Negocio (
    ...
    nombreNegocio varchar(25),
    direccionNegocio varchar(30),
    nitNegocio int,
...
INSERT INTO Usuario VALUES ('',"Santiago","Perez","SP1522","Santiago@gmail.com",'2002/05/12',1023978268,1,1,1),
...
SELECT * FROM ReporteUsuariosInactivos;
