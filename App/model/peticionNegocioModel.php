...
class peticionNegocio 
{
    ...
    public function __Negocio($idPeticionNegocio, $nombreNegocio, $nombrePropietario, $nitNegocio, $razonsocialNegocio, $telefonoNegocio, $fechaFundacion, $nombreTipoNegocio)
    {
    ...
    public function Registrar(peticionNegocio $data)
    {
        try {
