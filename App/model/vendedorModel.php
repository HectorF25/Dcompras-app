...
class vendedor extends Usuario{
    ...
    public function __Vendedor($idusuario, $correousuario, $contraseñausuario, $nombreusuario, $apellidousuario,$fechanacimiento, $documentousuario, $estadousuario, $idtipodoc,$direccionusuario, $imgUsuario,$idPerfilUsuario)
    {
