...
class clienteController
{
    ...
    {
        require_once  APP_VIEWS.'carritoCompras/catalogoCompras.php';
    }
    public function editarPerfilUsuario()
    {
        ...
        if (isset($_REQUEST['idUsuario'])) {
            ...
            require_once  APP_VIEWS.'carritoCompras/modules/headerPerfil.php';
            require_once  APP_VIEWS.'carritoCompras/cliente/editarPerfil.php';
            require_once  APP_VIEWS.'carritoCompras/modules/footerPerfil.php';
        } else {
            require_once  APP_VIEWS.'carritoCompras/modules/headerPerfil.php';
            require_once  APP_VIEWS.'carritoCompras/catalogoCompras.php';
            require_once  APP_VIEWS.'carritoCompras/modules/footerPerfil.php';
